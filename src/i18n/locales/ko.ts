...
export const ko: TranslationDictionary = {
  ...
  menu: {
    ...
    preferences: "환경설정",
    plugins: "플러그인",
    pluginsQuick: "플러그인 (Ctrl+Shift+X)",
    themesQuick: "테마 설정 (Ctrl+,)",
    languageQuick: "언어 설정",
  ...
  settings: {
    ...
    customThemes: "사용자 지정 및 커뮤니티 테마",
    customThemesDescription: "커뮤니티 CSS 스킨으로 에디터와 뷰어의 색상을 맞춤 설정하세요.",
    builtInThemes: "내장 테마 프리셋",
    openThemesFolder: "테마 폴더 열기",
    activeTheme: "적용 중",
    applyTheme: "테마 적용",
    appliedTheme: "적용됨",
    defaultTheme: "기본값",
    noCustomThemesInstalled: "설치된 사용자 지정 테마가 없습니다.",
    searchThemes: "테마 검색...",
    noThemesFound: "일치하는 테마를 찾을 수 없습니다.",
    installTheme: "설치",
    uninstallTheme: "제거",
  },
  window: {
